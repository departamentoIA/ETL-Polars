...
TABLES_TO_PROCESS = [
    ...
    # 'MVCARATULAS', 'MVFRMACTO', 'MVSOLICITUDES', 'MVVARACTO', 'PAGO_PORTAL',
]
...
col_drop = [
    ...
    'FCACTUALIZCONTRAS', 'FCULTINTLOGIN', 'DSEXTENCION', 'LLOFICINAMG',
    'DSPAGINAWEB', 'LLPROCESO', 'DSREFERENCIARQ', 'NOTXCOUNTRQ',
