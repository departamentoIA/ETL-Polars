...
col_date = ['FCETAPA', 'FCAPERTURA',
            'FCNACIMIENTO', 'FULTLOGIN', 'FCTRANSACCIONRS']
...
primary_keys = {
    ...
    'CTGIROS': 'LLGIRO',
    # 'CTMUNICIPIOS': 'LLMUNICIPIO', Not Primary Key
    'CTNACIONALIDADES': 'LLNACIONALIDAD',
    'CTOFICINAS': 'LLOFICINA',
    'CTSOCIOS': 'LLSOCIO',
    'CTTIPOSOCIEDAD': 'LLTIPOSOCIEDAD',
    'CTUSUARIOS_202511281728': 'LLUSUARIO',
    'DTCOMPSOCIOS': 'LLCOMPSOCIOS',
    'MVCARATULAS': 'LLCARATULA',
...
foreign_keys = {
    'BTSOLICITUDES': [{'MVSOLICITUDES': 'LLSOLICITUD'},
                      {'CTUSUARIOS_202511281728': 'LLUSUARIO'},
                      {'CTESTATUS': 'LLESTATUS'}],
    # 'CFVARIABLES', 'CTACCION', 'CTACTOS', 'CTCONDONACIONES', 'CTESTADOS'
    ...
    'CTFEDATARIOS': [{'CTNACIONALIDADES': 'LLNACIONALIDAD'},
                     {'CTMUNICIPIOS': 'LLMUNICIPIO'}, {
                         'CTESTADOS': 'LLESTADO'},
                     {'CTESTATUSFEDA': 'LLESTATUSFEDA'}],
    # 'CTGIROS', 'CTMUNICIPIOS', 'CTNACIONALIDADES'
    'CTOFICINAS': [{'CTMUNICIPIOS': 'LLMUNICIPIO'}, {'CTESTADOS': 'LLESTADO'}],
    'CTSOCIOS': [{'MVCARATULAS': 'LLCARATULA'},
                 {'CTNACIONALIDADES': 'LLNACIONALIDAD'}],
    # 'CTTIPOSOCIEDAD'
    'CTUSUARIOS_202511281728': [{'CTFEDATARIOS': 'LLFEDATARIO'},
                                {'CTOFICINAS': 'LLOFICINA'},],
    'DTCOMPSOCIOS': [{'CTNACIONALIDADES': 'LLNACIONALIDAD'}],
    'MVCARATULAS': [{'CTOFICINAS': 'LLOFICINA'}, {'CTMUNICIPIOS': 'LLMUNICIPIO'},
                    {'CTESTADOS': 'LLESTADO'}, {'CTGIROS': 'LLGIRO'},
                    {'CTTIPOSOCIEDAD': 'LLTIPOSOCIEDAD'},
                    {'CTNACIONALIDADES': 'LLNACIONALIDAD'},
                    {'CTESTATUSCARATULA': 'LLESTATUSCARATULA'}],
    'MVFRMACTO': [{'CTESTADOSACTO': 'LLESTDOACTO'}],
    'MVSOLICITUDES': [{'PAGO_PORTAL': 'LLPAGO'}, {'CTOFICINAS': 'LLOFICINA'},
                      {'CTESTATUS': 'LLESTATUS'}],
    'MVVARACTO': [{'MVFRMACTO': 'LLMVFRMACTO'}, {'CFVARIABLES': 'LLVARIABLE'}]
    # 'PAGO_PORTAL'
}

# Indexes of all tables ('table': 'column to create index')
table_indexes = {'BTSOLICITUDES': 'LLBTSOLICITUD', 'CFVARIABLES': 'LLVARIABLE',
                 'CTACCION': 'LLACCION', 'CTACTOS': 'LLACTO',
                 'CTCONDONACIONES': 'LLCONDONACION', 'CTESTADOS': 'LLESTADO',
                 'CTESTADOSACTO': 'LLESTDOACTO', 'CTESTATUS': 'LLESTATUS',
                 'CTESTATUSCARATULA': 'LLESTATUSCARATULA',
                 'CTESTATUSFEDA': 'LLESTATUSFEDA', 'CTFEDATARIOS': 'LLFEDATARIO',
                 'CTGIROS': 'LLGIRO',
                 # 'CTMUNICIPIOS': 'LLMUNICIPIO' No index
                 # 'CTNACIONALIDADES': 'LLNACIONALIDAD', 'CTOFICINAS': 'LLOFICINA',
                 'CTSOCIOS': 'LLSOCIO', 'CTTIPOSOCIEDAD': 'LLTIPOSOCIEDAD',
                 'CTUSUARIOS_202511281728': 'LLUSUARIO',
